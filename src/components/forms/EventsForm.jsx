    ...
    <div className="py-0">
        <div className="app-card">
            ...
            <form action={action}>
                ...
                {selectedJob && (
                <div className={styles.formLabel}>
                    <label htmlFor="job_detils">Job details:</label>
                    <textarea
                        id="job_details"
                ...
                <div className={styles.formLabel}>
                    ...
                    <input
                        ...
                        type="datetime-local"
                        name="start_datetime"
                        defaultValue={event?.start_datetime ? formatDateForInput(event?.start_datetime) : ""}
                        required
                        className={styles.formInput}
                    />
                </div>
                ...
                <div className={styles.formLabel}>
                    ...
                    <input
                        ...
                        type="datetime-local"
                        name="end_datetime"
                        defaultValue={event?.end_datetime ? formatDateForInput(event?.end_datetime) : ""}
                        className={styles.formInput}
                    />
                </div>
